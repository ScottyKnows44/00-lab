...
function displayPics(){
  ...
  // var only defines a variable globally or locally as when declared in a function. `let` lets you declare varibles that are blocked scope local variables. So, because you declare the variable "rando" in the while loop it is only defined in that loop.
  console.log(viewed);
